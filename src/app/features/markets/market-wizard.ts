...
import { MarketDetailsForm, createDetailsForm, detailsFields } from './details-form';
import { MarketLocationForm, createLocationForm, locationFields } from './location-form';
